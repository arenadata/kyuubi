...
export MAVEN_ARGS="-Pflink-provided,spark-provided,hive-provided,scala-2.13,spark-3.5 -Dmaven.javadoc.skip=true -Drat.skip=true -Dmaven.scalastyle.skip=true -Dspotless.check.skip=true"
