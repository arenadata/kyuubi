...
=======
export MAVEN_ARGS="-Pflink-provided,spark-provided,hive-provided -Dmaven.javadoc.skip=true -Drat.skip=true -Dmaven.scalastyle.skip=true -Dspotless.check.skip=true"
>>>>>>> Stashed changes
